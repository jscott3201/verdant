...
fn migration_0002_0003_coexist_with_generation_1_consumers() {
    ...
    migrations.sort();
    assert_eq!(migrations, vec!["0001_init.sql", "0002_receipts.sql", "0003_observations.sql", "0004_action_journal.sql", "0005_action_identity.sql", "0006_action_lifecycle.sql"]);
